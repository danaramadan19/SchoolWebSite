...
<section class="course" id="course">
    ...
    <div class="box-container">
        ...
        $result=$db->query("select * from  scourses where `studentid`='" . $sid . "'");
        ...
        for($i=0;$i<$result->num_rows;$i++)
        {
            ...
            echo " <a href='Scourse.php'  name='<?php echo".$row['courseid']."; ?> ' onclick='fun(this)' class='btn'> Go to the course> </a>";
        echo"</div>"  ;
        }
        ?>
...
<script>
    function fun(t1){
        ...
        t1.href="Scourse.php?id="+myArray2[0];
