...
<head>
    ...
    <link rel="stylesheet" href="styleAssi.css">
...
<section class="home" id="home">
    ...
    <p>Here you can see the courses that you will correct it's assigment during the semester,the information of the students you will correct to them</p>
...
<section class="course" id="course">
    ...
    <div class='box-container'>
        ...
        $result=$db->query("select * from assistantcourses where `assistantid`='" . $aid . "'");
if($result->num_rows>1){
   ...
   $num=$result->num_rows;
        ...
        for($i=0;$i<$num;$i++)
        {
            ...
            echo " <a href='coursePage.php' name='<?php echo".$row['courseID']."; ?> ' onclick='fun(this)' class='btn'> Go to the course> </a>";
            echo"</div>"  ;
        }
        ?>
</section>
...
let str=t1.name;
       ...
       t1.href="coursePage.php?id="+myArray2[0];
